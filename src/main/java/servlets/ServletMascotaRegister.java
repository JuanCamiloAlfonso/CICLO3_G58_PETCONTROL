...
/**
 * Servlet implementation class ServletMascotaRegister
 */
@WebServlet("/ServletMascotaRegister")
public class ServletMascotaRegister extends HttpServlet {
	...
	boolean premium = Boolean.parseBoolean(request.getParameter("premium"));
        ...
        String result = mascota.register(username, contrasena, nombre_mascota, raza, sexo, edad, peso, propietario, saldo, premium);
